...
def air_density(h):
    ...
    if h < 11000:
        ...
        Temp = 263.1905 - 76.32321 * (1 - np.sqrt(1 - ((h - 91000) / 19942.9)**2))
        P = 0.374 * np.exp(-G * (h - 86000) / (R_air * Temp))
...
def ambient_temp(h):
    ...
    if h < 11000:  # Troposphere (0 - 11 km)
        ...
        Temp = 263.1905 - 76.32321 * (1 - np.sqrt(1 - (h - 91000) / 19942.9))
...
def heat(T, v, h):
    q = k*(ambient_temp(h)*(1+(v/(np.sqrt(gamma*R_steak*ambient_temp(h)/M_steak)))**2*(gamma-1)/2)-T)
    return q
...
for t in range(time_steps):
    ...
    if t==time_steps//4: 
        ...
        plt.imshow(T_quarter[:,:,nz//2], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        ...
        plt.show()
        plt.figure(figsize=(6, 5))
        plt.imshow(T_quarter[nx//2,:,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        plt.colorbar(label="Temperature (K)")
        plt.title("2D Steak cross-section (25%)")
        plt.xlabel("x (m)")
        plt.ylabel("y (m)")
        plt.show()
        plt.figure(figsize=(6, 5))
        plt.imshow(T_quarter[:,ny//2,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        plt.colorbar(label="Temperature (K)")
        plt.title("2D Steak cross-section (25%)")
        plt.xlabel("x (m)")
        plt.ylabel("y (m)")
    ...
    if t==time_steps//2: 
        ...
        print("50%")
        plt.figure(figsize=(6, 5))
        plt.imshow(T_half[:,:,nz//2], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        plt.colorbar(label="Temperature (K)")
        ...
        plt.show()
        plt.figure(figsize=(6, 5))
        plt.imshow(T_half[nx//2,:,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        plt.colorbar(label="Temperature (K)")
        plt.title("2D Steak cross-section (50%)")
        plt.xlabel("x (m)")
        plt.ylabel("y (m)")
        plt.show()
        plt.figure(figsize=(6, 5))
        plt.imshow(T_half[:,ny//2,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        plt.colorbar(label="Temperature (K)")
        plt.title("2D Steak cross-section (50%)")
        plt.xlabel("x (m)")
        plt.ylabel("y (m)")
    ...
    if t==3*time_steps//4: 
        ...
        print("75%")
        plt.figure(figsize=(6, 5))
        plt.imshow(T_3_quarter[:,:,nz//2], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        plt.colorbar(label="Temperature (K)")
        ...
        plt.show()
        plt.figure(figsize=(6, 5))
        plt.imshow(T_3_quarter[nx//2,:,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        plt.colorbar(label="Temperature (K)")
        plt.title("2D Steak cross-section (75%)")
        plt.xlabel("x (m)")
        plt.ylabel("y (m)")
        plt.show()
        plt.figure(figsize=(6, 5))
        plt.imshow(T_3_quarter[:,ny//2,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        plt.colorbar(label="Temperature (K)")
        plt.title("2D Steak cross-section (75%)")
        plt.xlabel("x (m)")
        plt.ylabel("y (m)")
    ...
    if counter==0 and T[nx//2, ny//2, nz//2]>323:
        ...
        counter+=1
        plt.figure(figsize=(6, 5))
        plt.imshow(T[nx//2,:,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
        plt.colorbar(label="Temperature (K)")
...
plt.ylabel("y (m)")
plt.show()
plt.imshow(T[:,ny//2,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
plt.colorbar(label="Temperature (K)")
plt.title("2D Steak cross-section")
plt.xlabel("x (m)")
plt.ylabel("y (m)")
...
plt.imshow(T_max_arr[nx//2,:,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
plt.colorbar(label="Temperature (K)")
plt.title("2D Steak cross-section (Max reached temperature)")
plt.xlabel("x (m)")
plt.ylabel("y (m)")
plt.show()
plt.imshow(T_max_arr[:,ny//2,:], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
plt.colorbar(label="Temperature (K)")
plt.title("2D Steak cross-section (Max reached temperature)")
plt.xlabel("x (m)")
plt.ylabel("y (m)")
plt.show()
plt.imshow(T_max_arr[:,:,nz//2], cmap="hot", origin="lower", extent=[0, nx*dx, 0, ny*dy])
plt.colorbar(label="Temperature (K)")
plt.title("2D Steak cross-section (Max reached temperature)")
plt.xlabel("x (m)")
plt.ylabel("y (m)")
